...
class RemoteControlNode(Node):
    ...
    def init_button_actions(self):
        ...
        PRESSED_ACTION_MAP = {
            "START": self.go_home,
            "SELECT": partial(self.PressedFun, 0, key = 'legs_coord'),
        
            "L_HAT_UP": partial(self.PressedFun, 1.0, key = 'x'),
            "L_AXIS_UP": partial(self.PressedFun, 1.0, key = 'x'),
            "L_HAT_DOWN": partial(self.PressedFun, -1.0, key = 'x'),
            "L_AXIS_DOWN": partial(self.PressedFun, -1.0, key = 'x'),
            "L_HAT_LEFT": partial(self.PressedFun, np.radians(20.0), key = 'yaw_rate'),
            "L_AXIS_LEFT": partial(self.PressedFun, np.radians(20.0), key = 'yaw_rate'),
            "L_HAT_RIGHT": partial(self.PressedFun, np.radians(-20.0), key = 'yaw_rate'),
            "L_AXIS_RIGHT": partial(self.PressedFun, np.radians(-20.0), key = 'yaw_rate'),
        
            "TRIANGLE": partial(self.PressedFun, -0.15, key = 'height'),
            "CROSS": partial(self.PressedFun, 0.15, key = 'height'),
            "SQUARE": partial(self.PressedFun, 0.15, key = 'SQUARE'),
            "CIRCLE": partial(self.PressedFun, 0.15, key = 'CIRCLE'),
        
            "L1": partial(self.PressedFun, 0.015, key = 'pitch'),
            "L2": partial(self.PressedFun, -0.015, key = 'pitch'),
            "R1": partial(self.PressedFun, -0.15, key = 'x_shift'),
            "R2": partial(self.PressedFun, 0.15, key = 'x_shift'),
        }
        
        # 长按按键
        HOLD_ACTION_MAP = {
            "TRIANGLE": partial(self.HoldFun, -0.15, key = 'height'),
            "CROSS": partial(self.HoldFun, 0.15, key = 'height'),
            "SQUARE": partial(self.HoldFun, 0.15, key = 'SQUARE'),
            "CIRCLE": partial(self.HoldFun, 0.15, key = 'CIRCLE'),
        
            "L1": partial(self.HoldFun, 0.015, key = 'pitch'),
            "L2": partial(self.HoldFun, -0.015, key = 'pitch'),
            "R1": partial(self.HoldFun, -0.15, key = 'x_shift'),
            "R2": partial(self.HoldFun, 0.15, key = 'x_shift'),
        }
        
        # 释放按键
        RELEASED_ACTION_MAP = {
            "L_HAT_UP": partial(self.ReleaseFun, 0, key = 'x'),
            "L_AXIS_UP": partial(self.ReleaseFun, 0, key = 'x'),
            "L_HAT_DOWN": partial(self.ReleaseFun, 0, key = 'x'),
            "L_AXIS_DOWN": partial(self.ReleaseFun, 0, key = 'x'),
            "L_HAT_LEFT": partial(self.ReleaseFun, np.radians(0), key = 'yaw_rate'),
            "L_AXIS_LEFT": partial(self.ReleaseFun, np.radians(0), key = 'yaw_rate'),
            "L_HAT_RIGHT": partial(self.ReleaseFun, np.radians(0), key = 'yaw_rate'),
            "L_AXIS_RIGHT": partial(self.ReleaseFun, np.radians(0), key = 'yaw_rate'),
        }
    ...
    def go_home(self):
        ...
        PuppyPose = Stand.copy()
        PuppyMove = {'x': 0.0, 'y': 0.0, 'yaw_rate': 0.0}  # 确保初始值为 float 类型
        client = self.create_client(Empty, '/puppy_control/go_home')
